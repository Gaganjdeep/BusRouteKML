package ggn.com.busroutekml.routeHelper;
...
//	CallBack callBack;
//    public void drawRouteUsingStringAddress(GoogleMap map, Context c, String source, String dest, String language,CallBack callBack)
//    {
//        mMap = map;
//        context = c;
//        lang = language;
...
//    }
    ...
    private String makeURL(String source, String destination)
    {
        StringBuilder urlString = new StringBuilder();
    ...
    private void drawPath(String result, boolean withSteps)
    {
        try
        {
            ...
            for (int z = 0; z < list.size() - 1; z++)
            {
                ...
                line = mMap.addPolyline(new PolylineOptions().add(new LatLng(src.latitude, src.longitude), new LatLng(dest.latitude, dest.longitude)).width(10).color(Color.GREEN)
                        .geodesic(true));
            ...
            if (withSteps)
            {
                ...
                for (int i = 0; i < stepsArray.length(); i++)
                {
                    ...
                    mMap.addMarker(new MarkerOptions().position(step.location).title(step.distance).snippet(step.instructions)
